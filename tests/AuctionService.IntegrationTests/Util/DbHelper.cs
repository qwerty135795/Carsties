...
{
    public static void InitDb(AuctionDbContext context)
    {
        context.Auctions.AddRange(GetAuctionForTest());
        context.SaveChanges();
    }
    public static void ReInitDb(AuctionDbContext context)
    {
        context.Auctions.RemoveRange(context.Auctions);
        context.SaveChanges();
        InitDb(context);
    }
    public static List<Auction> GetAuctionForTest()
    {
